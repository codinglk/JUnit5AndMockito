package com.codinglk.tutorials.junit.security;
...
import com.codinglk.tutorials.junit.ui.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            ...
            UserLoginRequestModel creds = new UserLoginRequestModel();
            creds.setEmail(jsonRequest.get("email"));
            creds.setPassword(jsonRequest.get("password"));
